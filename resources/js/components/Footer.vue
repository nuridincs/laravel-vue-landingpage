              ...
              <div class="row">
                ...
                <div class="col-md-8 col-xs-12">
                  <p class="nunito-regular text">
                    Telp: <a class="" href="tel:+62742885822">0274-2885822</a><br />
                    WA: <a class="" href="https://api.whatsapp.com/send?phone=62895422447394">0895422447394</a><br />
                    Senin - Minggu <br />
                    24 Jam Non Stop
                  </p>
                  <p class="nunito-regular text"></p>
                </div>
              </div>
              <div class="row">
                <div class="mar_top1 hidden-xs hidden-xxs"></div>
                ...
                <div class="col-md-10 col-xs-12">
                  <p class="nunito-regular text">
                    ...
                    No 81 Jongkang, Sariharjo, Ngaglik, Sleman<br />
...
.footer .font-r-bold.text,.footer .nunito-regular.text{font-size:14px!important;color:#d7d7d7!important}
.footer .nunito-light.note{font-size:14px!important;color:#777!important}
